...
2. simulationvalidation.ipynb:
   This python notebook contains the code for the validation of our toy experiment data. Datasets from the CERN open data portal are required to properly run the code. They can be accessed here: https://opendata.cern.ch/record/93915. Due to the large nature of these datasets, 
